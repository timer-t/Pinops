...
{
    internal class AveragePool2D : Operation
    {
        ...
        internal AveragePool2D(Graph graph, Node input,
        ...
        {
            KernelExecutor.Execute(PoolingKernels.AveragePoolForwardKernel)(new Index1D(forward_num_kernels),
                                                                            input.Output.View,
        ...
        internal override void Backward()
        {
            if (!(input is Placeholder))
            {
                KernelExecutor.Execute(PoolingKernels.AveragePoolBackwardKernel)(new Index1D(backward_num_kernels),
                                                                                 Derivatives.View,
                                                                                 parametersBuffer.View,
